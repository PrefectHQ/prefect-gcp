...
## 0.1.2
Released on July 21st, 2022.

### Changed
Updated tests to be compatible with core Prefect library (v2.0b9) and bumped required version - [#20](https://github.com/PrefectHQ/prefect-gcp/pull/20)
